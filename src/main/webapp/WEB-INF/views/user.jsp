        ...
        <div class="form-profile">
            <div class="form-block">
                ...
                <div class="profile-input">
                    ...
                    <input type="text" autocomplete="off" required id="password">
                </div>
                <div class="profile-input">
                ...
                <div class="profile-input">
                    ...
                    <textarea  id="location" cols="10" rows="5"></textarea>
                </div>
                <div class="profile-input">
                    <label for="phone">Phone Number:</label>
                    <input type="tel" autocomplete="off" required id="phone">
                </div>
                <div class="form-btn">
                    <div>Give Admin Position</div>
                </div>
            </div>
        </div>
      </div>
