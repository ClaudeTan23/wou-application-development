...
<html lang="en">
   ...
   <body class="main-layout inner_posituong computer_page">
      <div class="modal">
         <form class="modal-block" method="POST" action="/upload-car" enctype="multipart/form-data">
            <input type="hidden" value="${_csrf.token}" name="${_csrf.parameterName}">
            <div class="modal-title">Add Car</div>
            <div class="group">
               <input type="text" required name="make_by" autocomplete="off">
               <span class="highlight"></span>
               <span class="bar"></span>
               <label>Make By:</label>
            </div>
            <div class="group">
               <input type="text" required name="model" autocomplete="off">
               <span class="highlight"></span>
               <span class="bar"></span>
               <label>Car Model:</label>
            </div>
            <div class="group">
               <input type="number" required name="registration_date" autocomplete="off">
               <span class="highlight"></span>
               <span class="bar"></span>
            ...
            <div class="group" style="margin: 0 0;">
               <input type="file" name="car-image" id="file" required/>
            </div>
      ...
      <div class="cars-container">
         <div class="search-container" style="padding: 20px 0;">
            <div style="padding: 0 10px;">
               <div class="select-btn">Add Car</div>
            </div>
            <div style="display: flex; gap: 15px;">
               <div class="select-menu">
               <div class="select-btn">
                  <span class="sBtn-text">Make By</span>
               ...
               <ul class="options">
                  <li class="option">
                     ...
                     <span class="option-text">Model</span>
                  </li>
                  <li class="option">
                     <i class="bx bxl-linkedin-square" style="color: #0E76A8;"></i>
                     <span class="option-text">Registration Date</span>
                  </li>
                  <li class="option">
                  ...
                  <li class="option">
                     ...
                     <span class="option-text">Make By</span>
                  </li>
               </ul>
            </div>
            <div style="display: flex; height: 100%; align-items: center; position: relative; margin-right: 10px;">
               <input type="text" id="search-bar" placeholder="Search Car..." style="background-color: #fff;" autocomplete="off">
         ...
         <c:choose>
            <c:when test="${cars.size() <= 0}">
               <div style="height: 90%; align-items: center; display: flex; font-size: 32px; font-family: sans-serif;"> Cars Not Exist </div>
            </c:when>
            <c:otherwise>
               <c:forEach var="i" begin="0" end="${cars.size() - 1}">
                  <a href="/car/${cars[i].getId()}" style="width: 100%; display: flex; align-items: center; justify-content: center;">
                     <div class="cars-block">
                        <div class="car-image-block">
                           <img src="/image/${cars[i].getImage()}" />
                        </div>
                        <div class="cars-block-info">
                           <div>${cars[i].getMake_by()}, ${cars[i].getModel()}, ${cars[i].getRegistration_date()}</div>
                           <!-- <div>${cars[i].getRegistration_date()}</div> -->
                           <div>
