      ...
      <div class="cars-container">
         <div class="search-container">
            <div style="padding: 0 10px; width: 340px; display: flex; gap: 10px;">
               <div class="select-btn" style="background-color: #cbcbcb;">My cars</div>
               <a  href="/myappointment"  class="select-btn">My Appointments</a>
            </div>
         ...
         <c:choose>
            <c:when test="${cars.size() <= 0}">
               <div style="height: 90%; align-items: center; display: flex; font-size: 32px; font-family: sans-serif; display: flex; justify-content: center;"> Cars Not
                  Exist </div>
            </c:when>
            <c:otherwise>
               <c:forEach var="i" begin="0" end="${cars.size() - 1}">
                  <a href="/car/${cars[i].getId()}"
